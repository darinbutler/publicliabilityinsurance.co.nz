    ...
    <>
      ...
      <main className="max-w-4xl mx-auto px-4 py-16">
        <div className="prose prose-sm max-w-none text-slate-700">
          ...
          <p>
            Cover4You (a trading style of GDS) ("we," "us," "our," or "Company") is committed to protecting your privacy. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you visit our website, contact us, or use our services.
          </p>
          <p>
