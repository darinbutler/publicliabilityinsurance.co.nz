...
export const metadata: Metadata = {
  title: 'Making a Claim | PublicLiabilityInsurance.co.nz',
  description: 'How to make a public liability and business insurance claim, our complaints process, and support for vulnerable customers. PublicLiabilityInsurance.co.nz is a referral service — claims are handled directly by your insurer.',
  alternates: { canonical: 'https://publicliabilityinsurance.co.nz/claims/' },
};
...
export default function ClaimsPage() {
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { '@type': 'ListItem', position: 2, name: 'Making a Claim', item: 'https://publicliabilityinsurance.co.nz/claims/' },
    ],
  };
      ...
      <section className="bg-slate-900 py-16 lg:py-20">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-lg text-slate-300 max-w-2xl leading-relaxed">
            Guidance on making a public liability and business insurance claim, our complaints process, and support if you need extra help.
          </p>
        </div>
      </section>
          ...
          <div className="flex gap-4 items-start">
            ...
            <div>
              ...
              <p className="text-amber-800 text-sm leading-relaxed">
                PublicLiabilityInsurance.co.nz connects you with licensed insurance advisers and brokers — we do not issue insurance policies or handle claims directly. To make a claim, contact your insurer using the details on your policy schedule. Unsure who your insurer is? Email <a href="mailto:hello@cover4you.co.nz" className="underline font-medium">hello@cover4you.co.nz</a> and we will help direct you.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-14 lg:py-20 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-slate-600 mb-10 leading-relaxed">
            If you experience a third-party injury, property damage, or liability incident, follow these steps to ensure your claim is handled as smoothly as possible.
          </p>
            ...
            <div className="bg-sky-50 rounded-xl p-6 border border-sky-200">
              <div className="flex gap-3 items-start">
                ...
                <div>
                  ...
                  <p className="text-sky-800 text-sm leading-relaxed">Never admit liability to a third party without first consulting your insurer. If you receive any legal documents, letters, or court papers relating to the incident, forward them to your insurer immediately without responding.</p>
                </div>
              </div>
            </div>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="bg-white rounded-xl p-6 border border-slate-200">
              ...
              <p className="text-slate-600 text-sm leading-relaxed mb-4">If you have a complaint about PublicLiabilityInsurance.co.nz or the referral service provided by Cover4You, please contact us in writing.</p>
