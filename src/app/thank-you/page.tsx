          ...
          <div className="bg-blue-50 border-l-4 border-blue-600 rounded-lg p-6 mb-8">
            ...
            <ul className="space-y-2 text-slate-700 mb-6">
              ...
              <li className="flex gap-2">
                ...
                <span>Email us: <a href="mailto:hello@cover4you.co.nz" className="text-blue-600 hover:text-blue-700 font-semibold">hello@cover4you.co.nz</a></span>
              </li>
            </ul>
          </div>
          ...
          <div className="bg-white rounded-lg border border-slate-200 p-8">
            ...
            <div className="space-y-6">
              <div>
                ...
                <p className="text-slate-700">
                  No problem! You can provide updated information before you finalise your choice. Just reply to our email.
                </p>
              </div>
        ...
        <section className="max-w-4xl mx-auto px-4 py-16">
          <div className="bg-gradient-to-r from-blue-600 to-emerald-600 rounded-lg p-8 text-white">
            ...
            <div className="space-y-3">
              <p className="text-blue-100">Have a question in the meantime?</p>
              <a
